...
cdef class NCLS:
    ...
    @cython.wraparound(False)
    @cython.initializedcheck(False)
    cpdef has_containment(self, const long [::1] starts, const long [::1] ends, const long [::1] indexes):
    ...
    # @cython.wraparound(False)
    # @cython.initializedcheck(False)
    # cpdef has_overlaps(self, const long [::1] starts, const long [::1] ends,
    #                    const long [::1] indexes, long nthreads=1):
    ...
    #     output_arr = np.ones(length, dtype=np.long) * -1
    #     cdef long [::1] output
    #     output = output_arr
    ...
    #     # num_threads2 = openmp.omp_get_num_threads()
    #     # print("number of threads after setting", num_threads2)
    ...
    @cython.wraparound(False)
    @cython.initializedcheck(False)
    cpdef no_overlaps(self, const long [::1] starts, const long [::1] ends, const long [::1] indexes):
